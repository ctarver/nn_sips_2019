function [y, RMSout, Idc, Vdc, PAPR] = RFWebLab_PA_meas_v1_1(x, RMSin)
...
[status,x, PAPR] = check_inputs_WebLab(x, RMSin);                                %Input validation check
...
function [status,x, PAPR] = check_inputs_WebLab(x, RMSin)
